...
var DateTimePicker = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(DateTimePicker, [{
    ...
    value: function handleOutsideActionListeners(shouldListen) {
      ...
      var fnName = shouldListenWithFallback ? 'addEventListener' : 'removeEventListener'; // eslint-disable-next-line max-len

      outsideActionEvents.forEach(function (eventName) {
        return currentDocument[fnName](eventName, _this2.onOutsideAction);
      });
...
DateTimePicker.propTypes = {
  ...
  currentDocument: _propTypes["default"].any,
